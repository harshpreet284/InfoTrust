  ...
  return (
    ...
    >
      <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
        ...
        <button
          type="button"
          className="w-full flex justify-center items-center py-2.5 px-4 mt-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors disabled:opacity-70"
          disabled
        >
          Create account
        </button>
